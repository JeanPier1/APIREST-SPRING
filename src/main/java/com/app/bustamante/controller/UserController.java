package com.app.bustamante.controller;
...
import com.app.bustamante.dao.UserRepository;
...
public class UserController {
	...
	public String showSignUpForm(User user, Model model) {
		model.addAttribute("tipos", tipoUserDao.findAll());
		return "add-user";
	}
